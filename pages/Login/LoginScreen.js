...
export default function Login({ navigation }) {
  ...
  const image = useStoreState((state) => state.imag);
  const setTema = useStoreActions((state) => state.setTema);
  ...
  return (
    ...
    >
      <Button onPress={() => setTema()} style={{ alignSelf: "flex-end" }}>
        <Text color={tema == "#FFFFFF" ? "black" : "white"}>
          {tema == "#FFFFFF" ? "Black" : "Light"}
        </Text>
      </Button>
      <Center bg="tertiary" w="100%" h="100%" style={{ backgroundColor: tema }}>
        ...
        >
          <Modal.Content bg="tertiary" borderColor="active" borderWidth="0px">
            ...
            <Modal.Body bg="tertiary" borderColor="active">
              <Text color="primary" fontFamily="RobotoSlab" fontWeight="400">
                Digite o endereço de e-mail que após confirmar será enviado um
                código e link para redefinir a senha.
              </Text>
              <FormControl mt="3">
                <FormControl.Label>
                  <Text color="primary" fontFamily="Quicksand" fontWeight="600">
            ...
            <Modal.Footer bg="tertiary" borderColor="active">
              <Button
                flex="1"
                onPress={() => {
                  navigation.navigate("RecoverPasswordStep1");
